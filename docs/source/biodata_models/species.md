...
| `COMMON_SQUIRREL_MONKEY` | `Saimiri sciureus` | `Common squirrel monkey` | `Registry.NCBI` | `NCBI:txid9521` |
| `CRAB_EATING_MACAQUE` | `Macaca fascicularis` | `Crab-eating macaque` | `Registry.NCBI` | `NCBI:txid9541` |
...
| `PIG_TAILED_MACAQUE` | `Macaca nemestrina` | `Pig-tailed macaque` | `Registry.NCBI` | `NCBI:txid9545` |
