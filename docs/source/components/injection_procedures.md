...
| `volume_unit` | Optional[[VolumeUnit](../biodata_models/units.md#volumeunit)] | Injection volume unit  |
| `duration` | `Optional[float]` | Injection duration  |
| `duration_unit` | Optional[[TimeUnit](../biodata_models/units.md#timeunit)] | Injection duration unit  |
| `injection_current` | `Optional[float]` | Injection current (uA)  |
| `injection_current_unit` | Optional[[CurrentUnit](../biodata_models/units.md#currentunit)] | Injection current unit  |
...
| `addgene_id` | Optional[[PIDName](../biodata_models/pid_names.md#pidname)] | Addgene id (Registry must be Addgene) |
