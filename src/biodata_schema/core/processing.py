...
from biodata_schema.base import AwareDatetimeWithDefault, DataCoreModel, DataModel, GenericModel
from biodata_schema.components.identifiers import Code, DataAsset  # noqa: F401
from biodata_schema.components.wrappers import AssetPath
from biodata_schema.utils.merge import merge_notes, merge_optional_list, merge_process_graph
...
class Processing(DataCoreModel):
    ...
    _DESCRIBED_BY_URL: str = DataCoreModel._DESCRIBED_BY_BASE_URL.default + "biodata_schema/core/processing.py"
