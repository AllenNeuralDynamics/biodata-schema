...
from biodata_schema.core.metadata import CORE_FILES
...
def process_core_file(core_file):
    ...
    model_docs_dir = os.path.join(base_dir, "docs", "base", "models", "biodata_schema", "core", core_file)
...
def process_components(component_folder, output_rel_path):
    ...
    component_docs_dir = os.path.join(
        base_dir, "docs", "base", "models", "biodata_schema", "components", component_folder
    )
...
def generate_all_component_documentation():
    ...
    """
    base_dir = os.path.abspath(os.path.join(os.path.dirname(__file__), "..", "..", "..", ".."))
    components_dir = os.path.join(base_dir, "docs", "base", "models", "biodata_schema", "components")
