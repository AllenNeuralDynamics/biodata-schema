...
from biodata_schema.base import DataModel, _GenericModel
from biodata_schema.utils.docs.utils import generate_enum_table
...
def check_for_union(value: str) -> str:
    ...
    Examples:
    Input: "List[typing.Annotated[biodata_schema.components.measurements.Calibration |
        biodata_schema.components.measurements.LiquidCalibration, FieldInfo(...)]]"
...
def process_data_model(attr, rel_dir_path, doc_folder, model_link_map):
    ...
    link = link.replace("biodata_schema/core/", "").replace("biodata_schema/", "")
