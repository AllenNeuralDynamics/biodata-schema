...
if stage_offset_from_origin is not None:
    image_to_acquisition_transform.append(
        Translation(
                ...
                ImagingConfig(
                    ...
                    channels=[
                        Channel(
                            ...
                            emission_wavelength=filter_wavelengths[channel_color],
